...
switch(true) do
{
	...
	{
		[[0,"News: Interpol has discovered an international drug gang!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: Oil tanker!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
