...
if("ToolKit" in (items player) && (damage _curTarget < 1)) then {_Btn1 ctrlEnable true;} else {_Btn1 ctrlEnable false;}; //Disables repairing blown up vehicle (merged commit 2054745 from Altis Repo)
